...
<div class="row">
    ...
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $brand = $conn->query("SELECT manufacturerID FROM manufacturers where delete_flag = 0 and `status` = 1")->num_rows;
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $car_types = $conn->query("SELECT carTypeID FROM carType where delete_flag = 0 and `status` = 1")->num_rows;
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $models = $conn->query("SELECT modelID FROM carModel where delete_flag = 0 and `status` = 1")->num_rows;
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Car Inventory</span>
        <span class="info-box-number text-right h5">
          <?php 
            $vehicles = $conn->query("SELECT inventoryID FROM inventory where delete_flag = 0 and `status` = 0")->num_rows;
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $vehicles = $conn->query("SELECT inventoryID FROM inventory where delete_flag = 0 and `status` = 1")->num_rows;
            echo format_num($vehicles);
          ?>
          <?php ?>
        </span>
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number text-right h5">
          <?php 
            $transactions = $conn->query("SELECT SUM(COALESCE((SELECT `price` from inventory where inventoryID = transaction_list.vehicle_id and delete_flag = 0), 0)) FROM transaction_list where date(date_created) = '".date('Y-m-d')."' ");
