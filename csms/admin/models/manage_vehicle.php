...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `inventory` where inventoryID = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
    <form action="" id="vehicle-form" enctype="multipart/form-data">
        <input type="hidden" name ="inventoryID" value="<?php echo isset($inventoryID) ? $inventoryID : '' ?>">
        <input type="hidden" name ="modelID" value="<?php echo isset($modelID) ? $modelID : (isset($_GET['modelID']) ? $_GET['modelID'] : '') ?>">
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="imagePath" class="control-label">Vehicle Image URL</label>
                <input type="text" name="imagePath" id="imagePath" class="form-control form-control-sm rounded-0" value="<?php echo isset($imagePath) ? $imagePath : ''; ?>"  required/>
            </div>
        </div>
        <div class="form-group d-flex justify-content-center">
			<img src="" alt="" id="car_img" class="img-fluid img-thumbnail" width="500px">
		</div>
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <label for="vr_number" class="control-label">Vehicle Registration No.</label>
                <input type="text" name="vr_number" id="vr_number" class="form-control form-control-sm rounded-0" value="<?php echo isset($vr_number) ? $vr_number : ''; ?>"  required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <input type="text" name="colors" id="colors" class="form-control form-control-sm rounded-0" value="<?php echo isset($colors) ? $colors : ''; ?>"  required/>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
