	...
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
                    <label for="levelID" class="control-label">Type</label>
                    <select name="levelID" id="levelID" class="form-control form-control-sm rounded-0" required>
                    <option value="1" <?php echo isset($meta['levelID']) && $meta['levelID'] == 1 ? 'selected' : '' ?>>Salesperson</option>
                    <option value="2" <?php echo isset($meta['levelID']) && $meta['levelID'] == 2 ? 'selected' : '' ?>>Staff</option>
                    </select>
                </div>
			</form>
		</div>
